                ...
                <Slider ref={sliderRef} {...settings}>
                    <div className='relative'>
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
                            <h2 data-aos="fade-down" data-aos-duration="1500" className="text-4xl md:text-6xl lg:text-7xl  font-semibold uppercase space-font z-10 text-white">Welcome to Swift MarketPlace!</h2>
                            ...
                            <Link to="/products" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="1000" className="browse-products-btn border-[1px] rounded item-center uppercase h-12 w-64 md:h-9 md:w-72 mt-5 duration-300 font-medium bg-blue-400 hover:bg-blue-200 hover:bg-opacity-70">Browse Products</Link>
                        </div>
                    </div>
                    <div className='relative'>
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
                            <h2 data-aos="fade-down" data-aos-duration="1500" className="text-4xl md:text-6xl lg:text-7xl  font-semibold uppercase space-font z-10 text-white">Elevate Your Presence with Captivating Fragrances</h2>
                            ...
                            <Link to="/products" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="1000" className="browse-products-btn border-[1px] rounded uppercase h-12 w-64 md:h-9 md:w-72 mt-5 duration-300 font-medium bg-blue-400 hover:bg-blue-200 hover:bg-opacity-70">Browse Products</Link>
                        </div>
                    </div>
                    <div className="relative">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
                            <h2 data-aos="fade-down" data-aos-duration="1500" className="text-4xl md:text-6xl lg:text-7xl  font-semibold uppercase space-font z-10 text-white">Explore Our Collection of Watches</h2>
                            <p data-aos="fade-right" data-aos-duration="1500" className="w-2/3 lg:w-1/2 z-20 text-sm md:text-base lg:text-lg xl:text-xl">Enjoy Shopping!</p>
                            <Link to="/products" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="1000" className="browse-products-btn border-[1px] rounded uppercase h-12 w-64 md:h-9 md:w-72 mt-5 duration-300 font-medium bg-blue-400 hover:bg-blue-200 hover:bg-opacity-70">Browse Products</Link>
                        </div>
                    </div>
                </Slider>
